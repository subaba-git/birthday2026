const questions = [
  { title: "今回の旅行で、いちばん重視したいのは？", answers: [
    ["🍴 ご当地グルメを満喫", ["food","city"]],
    ["🌿 絶景や自然を楽しむ", ["nature","photo"]],
    ["♨️ 温泉でゆっくり", ["relax"]],
    ["🏛️ 街や観光名所を巡る", ["city","history","active"]]
  ]},
  { title: "朝の過ごし方なら、どれが理想？", answers: [
    ["☀️ 朝から観光スタート", ["active","city"]],
    ["☕ ゆっくり起きて朝ごはん", ["relax","food"]],
    ["📸 朝の絶景を見に行く", ["photo","nature"]],
    ["🥐 カフェやおしゃれな朝食", ["food","city","photo"]]
  ]},
  { title: "惹かれる景色は？", answers: [
    ["🌊 海・海岸・港", ["sea","photo"]],
    ["🗻 山・高原・湖", ["nature","photo"]],
    ["🌇 街並み・夜景", ["city","photo"]],
    ["🏘️ レトロな町並み・古い建物", ["history","city","photo"]]
  ]},
  { title: "旅行中のペースは？", answers: [
    ["🏃 予定を詰めてたくさん回る", ["active"]],
    ["🚶 いくつか厳選して楽しむ", ["balanced","active"]],
    ["🛋️ ホテルや旅館でのんびり", ["relax"]],
    ["📷 写真を撮りながら気分で歩く", ["photo","balanced"]]
  ]},
  { title: "食べ歩きについては？", answers: [
    ["😍 食べ歩きが旅の目的になるくらい好き", ["food"]],
    ["😊 おいしい店があれば寄りたい", ["food","balanced"]],
    ["😌 食事はゆっくり座って楽しみたい", ["food","relax"]],
    ["🤔 食より観光を優先したい", ["active","city"]]
  ]},
  { title: "宿泊先に求めるものは？", answers: [
    ["♨️ 温泉旅館で癒やされたい", ["relax"]],
    ["🏨 おしゃれなホテルに泊まりたい", ["city","photo"]],
    ["🌲 自然を感じられる宿がいい", ["nature","relax"]],
    ["🚉 観光に便利な場所がいい", ["city","train","active"]]
  ]},
  { title: "温泉への興味は？", answers: [
    ["♨️ 絶対に入りたい", ["relax"]],
    ["😊 あればうれしい", ["relax","balanced"]],
    ["😌 どちらでもいい", ["balanced"]],
    ["🙅 温泉より観光を楽しみたい", ["active","city"]]
  ]},
  { title: "海が見える場所は？", answers: [
    ["🌊 海があると最高！", ["sea"]],
    ["😊 あれば立ち寄りたい", ["sea","photo"]],
    ["😌 なくても大丈夫", ["balanced"]],
    ["🌲 山や湖のほうが好き", ["nature"]]
  ]},
  { title: "歴史や文化スポットは？", answers: [
    ["🏯 大好き。しっかり巡りたい", ["history","active"]],
    ["😊 有名なら見てみたい", ["history","city"]],
    ["😌 街歩きの途中なら寄りたい", ["history","balanced"]],
    ["🌿 自然や景色を優先したい", ["nature","photo"]]
  ]},
  { title: "写真を撮るなら何を一番残したい？", answers: [
    ["🗻 絶景", ["photo","nature"]],
    ["🍰 カフェ・料理", ["photo","food"]],
    ["🏛️ 建物・街並み", ["photo","history","city"]],
    ["🫶 2人の思い出写真", ["photo","relax"]]
  ]},
  { title: "移動時間については？", answers: [
    ["🚃 近いほうがうれしい", ["near"]],
    ["🚄 多少遠くてもOK", ["far"]],
    ["🚅 電車旅も楽しみたい", ["train","far"]],
    ["🗺️ 移動時間は気にしない", ["far"]]
  ]},
  { title: "旅行中の移動手段でテンションが上がるのは？", answers: [
    ["🚆 電車・特急・新幹線", ["train"]],
    ["🚗 ドライブ", ["near","active"]],
    ["🚶 徒歩で街を散策", ["city","history","active"]],
    ["🚌 乗り物はラクなら何でもOK", ["balanced","relax"]]
  ]},
  { title: "旅行先の雰囲気は？", answers: [
    ["✨ 少し贅沢で特別感", ["relax","city","photo"]],
    ["🌿 自然の中で非日常", ["nature","photo"]],
    ["🎉 にぎやかで楽しい", ["city","active","food"]],
    ["🏘️ 落ち着いた昔ながらの町", ["history","relax"]]
  ]},
  { title: "旅行でやってみたいことは？", answers: [
    ["🍴 名物を食べ尽くす", ["food"]],
    ["🥾 自然の中を歩く・遊ぶ", ["nature","active"]],
    ["🛍️ 観光・買い物・カフェ巡り", ["city","food","active"]],
    ["🛁 宿でゆっくり過ごす", ["relax"]]
  ]},
  { title: "旅先での夜はどうしたい？", answers: [
    ["🌃 夜景や夜の街を歩く", ["city","photo","active"]],
    ["🍴 ご当地ディナーを楽しむ", ["food","city"]],
    ["♨️ 温泉に入ってゆっくり", ["relax"]],
    ["📸 静かな景色を眺めたい", ["nature","photo","relax"]]
  ]},
  { title: "1泊2日なら、どんな旅が理想？", answers: [
    ["🎯 行きたい場所を絞って濃く楽しむ", ["active","balanced"]],
    ["🌿 余白を多めにしてのんびり", ["relax","nature"]],
    ["🍴 食中心で楽しむ", ["food"]],
    ["🗺️ できるだけ多くの名所を回る", ["city","history","active"]]
  ]},
  { title: "『また行きたい』と思うのはどんな旅？", answers: [
    ["🌊 海と絶景が印象に残る旅", ["sea","photo"]],
    ["♨️ 心身が休まる旅", ["relax"]],
    ["🍜 おいしいものが忘れられない旅", ["food"]],
    ["🏯 新しい発見が多い旅", ["history","city","active"]]
  ]},
  { title: "誕生日旅行だからこそ、欲しいものは？", answers: [
    ["💎 特別感・ちょっと贅沢", ["relax","city"]],
    ["📸 写真に残る絶景", ["photo","nature"]],
    ["🍰 おいしいものとスイーツ", ["food"]],
    ["🎁 いつもと違う体験", ["active","far","city"]]
  ]},
  { title: "最後に、今いちばん近い気分は？", answers: [
    ["🌊 海を見に行きたい！", ["sea","photo"]],
    ["🌲 自然に癒やされたい！", ["nature","relax"]],
    ["🍴 おいしいものを楽しみたい！", ["food","city"]],
    ["✨ いつもと違う場所へ行きたい！", ["city","history","far"]]
  ]}
];
...
function showResult() {
  ...
  selected.flat().forEach(answerKey => {
    Object.entries(destinations).forEach(([name, data]) => {
      totals[name] += data.score[answerKey] || 0;
    });
  });
  ...
  localStorage.setItem("travelDiagnosisAt", new Date().toISOString());
