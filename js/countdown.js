...
const configuredDestination = typeof TRIP_DESTINATION !== "undefined" ? TRIP_DESTINATION : "旅行先";
destinationName.textContent = configuredDestination;
const adminDiagnosisResult = document.getElementById("adminDiagnosisResult");
if (adminDiagnosisResult) adminDiagnosisResult.textContent = configuredDestination;
...
function startCelebration() {
  ...
  for (let i = 0; i < 45; i++) {
    ...
    item.textContent = confettiEmojis[i % confettiEmojis.length];
